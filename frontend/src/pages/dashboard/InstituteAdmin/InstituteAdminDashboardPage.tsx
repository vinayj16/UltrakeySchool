...
const InstituteAdminDashboardPage: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch dashboard data and user credentials in parallel
      const [dashboardResponse, credentialsResponse] = await Promise.all([
        apiClient.get('/dashboard/institute-admin'),
      ...
      if (credentialsResponse.data.success) {
        setUserCredentials(credentialsResponse.data.data || [])
      }
              ...
              <div className="card">
                <div className="card-header d-flex align-items-center justify-content-between">
                  ...
                  <div className="d-flex gap-2">
                    <button className="btn btn-info btn-sm" onClick={() => window.location.href = '/user-management/pending-requests'}>
                      <i className="ti ti-user-plus me-1" />Pending Requests
                    </button>
                            ...
                            <tr key={cred.userId}>
                              ...
                              <td>
                                <span className={`badge ${
                                  ...
                                  cred.role === 'school_admin' ? 'bg-success' :
