                ...
                <div className="col-xl-2 col-md-3 col-sm-4 col-6">
                  <Link to="/teachers" className="card border-0 border-bottom border-success border-2 animate-card">
                    <div className="card-body text-center">
                      ...
                      <h6 className="mb-0">Manage Teachers</h6>
                    </div>
                  </Link>
                </div>
                <div className="col-xl-2 col-md-3 col-sm-4 col-6">
                  <Link to="/classes" className="card border-0 border-bottom border-warning border-2 animate-card">
                    <div className="card-body text-center">
                      <div className="avatar avatar-lg bg-warning rounded mb-2 mx-auto">
                        <i className="ti ti-school fs-24"></i>
                      </div>
                      <h6 className="mb-0">Manage Classes</h6>
                    </div>
                  </Link>
                </div>
                <div className="col-xl-2 col-md-3 col-sm-4 col-6">
                  <Link to="/attendance" className="card border-0 border-bottom border-dark border-2 animate-card">
                    <div className="card-body text-center">
