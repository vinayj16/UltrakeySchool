      ...
      <div className="d-flex align-items-center justify-content-between flex-wrap p-3 bg-white pb-0 mb-4">
        ...
        <div className="d-flex align-items-center flex-wrap">
          <div className="d-flex align-items-center bg-white border rounded-2 p-1 mb-3 me-2">
            <Link to="/tickets" className="active btn btn-icon btn-sm me-1 primary-hover">
              <i className="ti ti-list-tree"></i>
            </Link>
            <Link to="/ticket-grid" className="btn btn-icon btn-sm bg-light primary-hover">
            ...
            tickets.map((ticket) => (
              <div key={ticket._id} className="card mb-3">
                <div className="card-header d-flex align-items-center justify-content-between flex-wrap p-3 pb-0">
                  <h5 className="text-primary mb-3">{ticket.category.primary}</h5>
                  <div className="d-flex align-items-center mb-1">
                    <span className={`badge ${getPriorityBadgeClass(ticket.priority.level)} d-inline-flex align-items-center mb-2 me-4`}>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="flex-grow-1">
                      ...
                      <div className="d-flex align-items-center mb-2">
                        <h5 className="fw-semibold me-2 mb-0">
                      ...
                      <div className="d-flex align-items-center flex-wrap">
                        {ticket.assignment?.assignedTo && (
                          <p className="d-flex align-items-center me-3 mb-1">
                            <i className="ti ti-user me-1"></i>
                            Assigned to <span className="text-dark ms-1">{ticket.assignment.assignedTo.name}</span>
                          </p>
                        )}
                        <p className="d-flex align-items-center text-muted me-3 mb-1">
          ...
          <div className="card">
            ...
            <div className="card-body p-0">
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center">
                    <i className="ti ti-clock-pause me-2 text-warning"></i>
                    <span>Pending</span>
                  </div>
                  <span className="badge bg-warning rounded-pill">{statistics?.pending || 0}</span>
                </li>
                <li className="list-group-item d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center">
