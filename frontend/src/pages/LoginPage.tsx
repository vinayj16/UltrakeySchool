...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('[LoginPage] Clearing existing session before login');
    ...
    try {
      ...
      if (response.data.success) {
        ...
        console.log('[LoginPage] User role (raw):', user.role);
        ...
        // Double-check the role mapping
        const testMapping = getRoleBasedDashboard('SUPER_ADMIN');
        console.log('[LoginPage] Test mapping for SUPER_ADMIN:', testMapping);
        
        // Redirect to role-specific dashboard
        console.log('[LoginPage] About to navigate to:', dashboardPath);
        navigate(dashboardPath, { replace: true });
        
        // Force page reload to ensure auth store is updated
        console.log('[LoginPage] Forcing redirect to:', dashboardPath);
