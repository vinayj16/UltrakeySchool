          ...
          <div className="col-xxl-6 col-xl-7 col-md-6">
            <div className="d-flex flex-column justify-content-between vh-100">
              ...
              <div className="d-flex flex-column justify-content-center align-items-center mb-4">
                <div className="mb-4">
                  <img src="/assets/img/authentication/error-404.svg" className="error-img img-fluid" alt="Img" />
                </div>
                <h3 className="h2 mb-3">Oops, something went wrong</h3>
                <p className="text-center">Error 404 Page not found. Sorry the page you looking for doesn't exist or has been moved</p>
