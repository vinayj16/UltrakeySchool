        ...
        <div className="auth-right-scroll">
          <div className="auth-right-inner">
            ...
            <div className="auth-right-form">
              ...
              {/* Temporary dummy content to test scrolling */}
              <div style={{ height: '500px', background: 'linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%, #f5f7fa 100%)', borderRadius: '8px', marginTop: '20px' }}>
                <p style={{ padding: '20px', color: '#667eea', fontSize: '14px', textAlign: 'center' }}>Temporary content to test scrolling functionality</p>
                <div style={{ height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <p style={{ color: '#718096', fontSize: '18px', fontWeight: '600' }}>Scroll Test Content</p>
                </div>
              </div>
            </div>
