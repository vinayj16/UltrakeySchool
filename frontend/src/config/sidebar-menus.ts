...
export const getSidebarMenu = (roleId: string): MenuSection[] => {
  // Map role variations to the correct sidebar key
  ...
  const mappedRole = roleMapping[roleId] || roleId.toUpperCase();
  console.log('Sidebar role mapping:', roleId, '->', mappedRole);
  
  return SIDEBAR_MENUS[mappedRole] || SIDEBAR_MENUS.SCHOOL_ADMIN
}
