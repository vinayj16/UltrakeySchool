...
export type UserRole = 'super_admin' | 'institution_admin' | 'school_admin' | 'teacher' | 'student' | 'parent' | 'accountant' | 'hr' | 'librarian' | 'transport_manager' | 'hostel_warden';
...
export const ROLES: Role[] = [
  ...
  // Institution Admin (School Owner)
  {
    ...
    icon: 'ti ti-building',
    color: 'primary',
    description: 'School owner with full control over institution management',
    category: 'admin',
