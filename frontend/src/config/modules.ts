...
export const MODULE_LIST: Module[] = [
  ...
  },
  {
    ...
    description: 'Manage institution users, credentials, and requests',
    icon: 'users',
    ...
    features: ['user-creation', 'credential-management', 'request-approval'],
    dependencies: [],
    enabled: true
  },
  {
    id: 'user-management-pending-requests',
    name: 'Pending Requests',
    description: 'Review and approve account requests',
    icon: 'user-plus',
    route: '/user-management/pending-requests',
    permissions: {
      create: false,
      read: true,
      update: true,
    ...
    features: ['request-approval', 'user-review'],
    dependencies: [],
    enabled: true
  },
  {
    id: 'user-management-create-credentials',
    name: 'Create Credentials',
    description: 'Generate login credentials for users',
    icon: 'user-check',
    route: '/user-management/create-credentials',
    permissions: {
      create: true,
      read: true,
      update: true,
    ...
    features: ['credential-creation', 'user-management'],
    dependencies: [],
    enabled: true
  },
  {
    id: 'user-management-directory',
    name: 'User Directory',
    description: 'View and manage all institution users',
    icon: 'users',
    route: '/user-management/directory',
    permissions: {
      create: false,
      read: true,
      update: true,
    ...
    features: ['user-directory', 'user-search', 'user-filtering'],
    dependencies: [],
    enabled: true
  },
  {
