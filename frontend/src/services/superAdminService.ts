...
export const superAdminService = {
  ...
  getExpiryAlerts: async (): Promise<ExpiryAlert[]> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch expiry alerts');
      }
  ...
  getRenewalReminders: async (): Promise<RenewalReminder[]> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch renewal reminders');
      }
  ...
  getAutoRenewSettings: async (): Promise<AutoRenewSetting[]> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch auto-renew settings');
      }
  ...
  reactivateInstitution: async (institutionId: string): Promise<{ success: boolean; message: string }> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to reactivate institution');
      }
  ...
  getAlertsSummary: async (): Promise<Record<string, unknown>> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch alerts summary');
      }
  ...
  getInstitutionsAnalytics: async (): Promise<Record<string, unknown>> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch institutions analytics');
      }
  ...
  getBranchAnalytics: async (): Promise<Record<string, unknown>> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch branch analytics');
      }
  ...
  getAuditLogSummary: async (): Promise<Record<string, unknown>> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch audit log summary');
      }
  ...
  getBranchStudents: async (branchId: string): Promise<Record<string, unknown>[]> => {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch branch students');
      }
