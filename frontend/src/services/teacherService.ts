...
export const teacherService = {
  ...
  async getById(id: string): Promise<Teacher> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch teacher');
      }
  ...
  async search(query: string): Promise<Teacher[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to search teachers');
      }
  ...
  async getByDepartment(department: string): Promise<Teacher[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch teachers by department');
      }
  ...
  async getSubjects(id: string): Promise<Record<string, unknown>[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch teacher subjects');
      }
  ...
  async getTimetable(id: string): Promise<Record<string, unknown>[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch teacher timetable');
      }
  ...
  async getLeaves(id: string): Promise<Record<string, unknown>[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch teacher leaves');
      }
  ...
  async applyLeave(id: string, leaveData: Record<string, unknown>): Promise<Record<string, unknown>> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to apply for leave');
      }
