...
export const homeworkService = {
  ...
  async create(data: CreateHomeworkInput): Promise<Homework> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to create homework');
    }
  ...
  async update(id: string, data: UpdateHomeworkInput): Promise<Homework> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to update homework');
    }
  ...
  async delete(id: string): Promise<void> {
    ...
    if (!response.success) {
      throw new Error(response.error || 'Failed to delete homework');
    }
  },
  ...
  async submit(homeworkId: string, formData: FormData): Promise<HomeworkSubmission> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to submit homework');
    }
