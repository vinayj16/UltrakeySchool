...
const institutionService = {
  async createInstitution(formData: InstitutionFormData): Promise<Institution> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to create institution');
    }
  ...
  async searchInstitutions(query: string, limit?: number): Promise<Institution[]> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to search institutions');
    }
  ...
  async getInstitutionsByType(type: string): Promise<Institution[]> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to fetch institutions by type');
    }
  ...
  async getInstitutionsByCategory(category: string): Promise<Institution[]> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to fetch institutions by category');
    }
  ...
  async getInstitutionsBySubscriptionStatus(status: string): Promise<Institution[]> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to fetch institutions by subscription status');
    }
  ...
  async getExpiringSubscriptions(days?: number): Promise<Institution[]> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to fetch expiring subscriptions');
    }
  ...
  async getInstitutionMetrics(id: string): Promise<Record<string, unknown>> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to fetch institution metrics');
    }
  ...
  async suspendInstitution(id: string, reason: string): Promise<Institution> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to suspend institution');
    }
  ...
  async updateAnalytics(id: string, analyticsData: Record<string, unknown>): Promise<Institution> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to update analytics');
    }
  ...
  async updateLastLogin(id: string): Promise<void> {
    ...
    if (!response.success) {
      throw new Error(response.error || 'Failed to update last login');
    }
  },
  ...
  async updateExpiredSubscriptions(): Promise<{ updatedCount: number }> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to update expired subscriptions');
    }
  ...
  async migrateFromSchool(schoolId: string): Promise<Institution> {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to migrate from school');
    }
