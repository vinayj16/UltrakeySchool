...
export const emailSettingsService = {
  getEmailSettings: async (institutionId: string): Promise<EmailSettings> => {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to fetch email settings');
    }
  ...
  updatePhpMailerSettings: async (institutionId: string, data: PhpMailerSettingsInput): Promise<EmailSettings> => {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to update PHPMailer settings');
    }
  ...
  updateSmtpSettings: async (institutionId: string, data: SmtpSettingsInput): Promise<EmailSettings> => {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to update SMTP settings');
    }
  ...
  updateGoogleSettings: async (institutionId: string, data: GoogleSettingsInput): Promise<EmailSettings> => {
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to update Google settings');
    }
  ...
  toggleProvider: async (
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to toggle email provider');
    }
  ...
  testEmailConnection: async (
    ...
    if (!response.success || !response.data) {
      throw new Error(response.error || 'Failed to test email connection');
    }
