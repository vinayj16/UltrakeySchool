...
export const subjectService = {
  ...
  async bulkDelete(ids: string[]): Promise<void> {
    try {
      ...
      if (!response.success) {
        throw new Error(response.error || 'Failed to bulk delete subjects');
      }
    } catch (error) {
  ...
  async getByClass(classId: string): Promise<Subject[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch subjects by class');
      }
  ...
  async getByTeacher(teacherId: string): Promise<Subject[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch subjects by teacher');
      }
  ...
  async getBySemester(semester: string): Promise<Subject[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch subjects by semester');
      }
  ...
  async getAssignments(subjectId: string): Promise<Record<string, unknown>[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch subject assignments');
      }
  ...
  async getExams(subjectId: string): Promise<Record<string, unknown>[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch subject exams');
      }
  ...
  async getMaterials(subjectId: string): Promise<Record<string, unknown>[]> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch subject materials');
      }
  ...
  async toggleActive(subjectId: string, isActive: boolean): Promise<Subject> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to toggle subject active status');
      }
  ...
  async exportCSV(filters: SubjectFilters = {}): Promise<Blob> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to export subjects as CSV');
      }
  ...
  async exportPDF(filters: SubjectFilters = {}): Promise<Blob> {
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to export subjects as PDF');
      }
  ...
  async getStatistics(): Promise<{
    ...
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(response.error || 'Failed to fetch subject statistics');
      }
