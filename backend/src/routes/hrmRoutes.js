...
// Leave Type Routes
router.post('/leave-types', leaveTypeController.create);
router.get('/leave-types', leaveTypeController.getAll);
router.get('/leave-types/:id', leaveTypeController.getById);
router.put('/leave-types/:id', leaveTypeController.update);
router.delete('/leave-types/:id', leaveTypeController.delete);
...
router.post('/staff-documents', staffDocumentController.upload, staffDocumentController.create);
router.get('/staff-documents', staffDocumentController.getAll);
router.get('/staff-documents/:id', staffDocumentController.getById);
router.get('/staff-documents/:id/download', staffDocumentController.download);
router.put('/staff-documents/:id', staffDocumentController.update);
router.delete('/staff-documents/:id', staffDocumentController.delete);
