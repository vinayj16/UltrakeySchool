...
router.get('/my-allocation',
  ...
  async (req, res) => {
    try {
      ...
      const ApiResponse = (await import('../utils/apiResponse.js')).default;
      return ApiResponse.error(res, 'Failed to retrieve allocation', 500);
    }
  }
);
...
router.get('/dashboard/stats',
  ...
  async (req, res) => {
    try {
      ...
      const ApiResponse = (await import('../utils/apiResponse.js')).default;
      return ApiResponse.error(res, 'Failed to retrieve dashboard stats', 500);
    }
  }
);
...
router.get('/dashboard/rooms',
  ...
  async (req, res) => {
    try {
      ...
      const ApiResponse = (await import('../utils/apiResponse.js')).default;
      return ApiResponse.error(res, 'Failed to retrieve room data', 500);
    }
  }
);
...
router.get('/dashboard/occupancy',
  ...
  async (req, res) => {
    try {
      ...
      const ApiResponse = (await import('../utils/apiResponse.js')).default;
      return ApiResponse.error(res, 'Failed to retrieve occupancy data', 500);
    }
  }
);
...
router.get('/maintenance',
  ...
  async (req, res) => {
    try {
      ...
      const ApiResponse = (await import('../utils/apiResponse.js')).default;
      return ApiResponse.error(res, 'Failed to retrieve maintenance records', 500);
    }
  }
);
...
router.get('/inventory',
  ...
  async (req, res) => {
    try {
      ...
      const ApiResponse = (await import('../utils/apiResponse.js')).default;
      return ApiResponse.error(res, 'Failed to retrieve inventory', 500);
    }
  }
);
