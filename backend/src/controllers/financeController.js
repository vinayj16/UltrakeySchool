...
const feeStructureController = {
  ...
  create: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to create fee structure', 500);
    }
  },
  ...
  getAll: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve fee structures', 500);
    }
  },
  ...
  getById: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve fee structure', 500);
    }
  },
  ...
  update: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to update fee structure', 500);
    }
  },
  ...
  delete: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to delete fee structure', 500);
    }
  }
};
...
const invoiceController = {
  ...
  create: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to create invoice', 500);
    }
  },
  ...
  getAll: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve invoices', 500);
    }
  },
  ...
  getById: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve invoice', 500);
    }
  },
  ...
  update: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to update invoice', 500);
    }
  },
  ...
  markAsPaid: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to mark invoice as paid', 500);
    }
  }
};
...
const transactionController = {
  ...
  getAll: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve transactions', 500);
    }
  }
};
...
const budgetController = {
  ...
  create: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to create budget', 500);
    }
  },
  ...
  getAll: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve budgets', 500);
    }
  }
};
...
const salaryController = {
  ...
  processSalary: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to process salary', 500);
    }
  },
  ...
  getAll: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve salaries', 500);
    }
  }
};
...
const paymentController = {
  ...
  handleWebhook: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, `Webhook error: ${error.message}`, 400);
    }
  },
  ...
  getPaymentHistory: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve payment history', 500);
    }
  },
  ...
  getPaymentMethods: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve payment methods', 500);
    }
  }
};
...
const expenseCategoryController = {
  getExpenseCategories: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve expense categories', 500);
    }
  }
};
...
const taxRateController = {
  getTaxRates: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve tax rates', 500);
    }
  }
};
...
const dashboardController = {
  getDashboardData: async (req, res) => {
    try {
      ...
      return ApiResponse.error(res, 'Failed to retrieve finance dashboard data', 500);
    }
  }
};
